...
Begin VB.Form frmOpciones 
   ...
   Begin VB.PictureBox picContenedor 
      ...
      Top             =   480
      Width           =   6285
      Begin VB.CheckBox chkWallpaper 
         Caption         =   "Colocar Caratula com wallpaper"
         Height          =   240
         Left            =   285
         TabIndex        =   280
         Top             =   180
   ...
   Begin VB.PictureBox picContenedor 
      ...
      Begin VB.ListBox lstVis 
         Height          =   450
         ItemData        =   "Options.frx":12CCA
         Left            =   60
         List            =   "Options.frx":12CD4
         TabIndex        =   259
         Top             =   675
         Width           =   1665
      End
      ...
      Begin VB.PictureBox picVis 
         ...
         Begin VB.PictureBox picVisSpect 
            ...
            Begin VB.ComboBox cboVis 
               Height          =   315
               Index           =   6
               ItemData        =   "Options.frx":12CF4
               Left            =   1725
               List            =   "Options.frx":12D07
               Style           =   2  'Dropdown List
               TabIndex        =   235
               Top             =   3795
               Width           =   1950
            ...
            Begin VB.ComboBox cboVis 
               Height          =   315
               Index           =   5
               ItemData        =   "Options.frx":12D1A
               Left            =   1725
               List            =   "Options.frx":12D2D
               Style           =   2  'Dropdown List
               TabIndex        =   234
               Top             =   3450
               Width           =   1950
            ...
            Begin VB.ComboBox cboVis 
               Height          =   315
               Index           =   7
               ItemData        =   "Options.frx":12D40
               Left            =   1725
               List            =   "Options.frx":12D50
               Style           =   2  'Dropdown List
               TabIndex        =   233
               Top             =   4140
               Width           =   1950
            ...
            Begin VB.ComboBox cboVis 
               Height          =   315
               Index           =   4
               ItemData        =   "Options.frx":12D71
               Left            =   1725
               List            =   "Options.frx":12D7B
               Style           =   2  'Dropdown List
               TabIndex        =   232
               Top             =   2745
               Width           =   1950
            ...
            Begin VB.ComboBox cboVis 
               Height          =   315
               Index           =   3
               ItemData        =   "Options.frx":12D88
               Left            =   1725
               List            =   "Options.frx":12D98
               Style           =   2  'Dropdown List
               TabIndex        =   229
               Top             =   1380
               Width           =   1950
            ...
            Begin VB.ComboBox cboVis 
               Height          =   315
               Index           =   2
               ItemData        =   "Options.frx":12DDE
               Left            =   1725
               List            =   "Options.frx":12DE8
               Style           =   2  'Dropdown List
               TabIndex        =   228
               Top             =   690
               Width           =   1950
            ...
            Begin VB.ComboBox cboVis 
               Height          =   315
               Index           =   1
               ItemData        =   "Options.frx":12DF5
               Left            =   1725
               List            =   "Options.frx":12DFF
               Style           =   2  'Dropdown List
               TabIndex        =   227
               Top             =   345
               Width           =   1950
            ...
            Begin VB.ComboBox cboVis 
               Height          =   315
               Index           =   0
               ItemData        =   "Options.frx":12E0C
               Left            =   1725
               List            =   "Options.frx":12E19
               Style           =   2  'Dropdown List
               TabIndex        =   225
               Top             =   0
               Width           =   1950
      ...
      Begin VB.PictureBox picVis 
         ...
         Begin VB.ComboBox cboVis 
            ...
            Height          =   315
            Index           =   8
            ItemData        =   "Options.frx":12E3A
            Left            =   1470
            List            =   "Options.frx":12E47
            Style           =   2  'Dropdown List
            TabIndex        =   266
            Top             =   750
            Width           =   1950
...
' chkWallpaper.Value = Not chkWallpaper.Value
'   If chkWallpaper.Value = 1 Then
'     ConfigurarWallpaper
'   Else
...
Sub chkDSP_Click(Index As Integer)
    Dim i As Integer
  '=================================================================
...
Private Sub cmdApply_Click()
  On Error Resume Next
   ...
   If LCase(Trim(txtDisplay(0).Text)) <> LCase(sFormatPlayList) Then
      ...
      Dim i As Integer
      For i = 0 To frmPlayList.PL.Rows - 1
...
Private Sub Slider1_Scroll()
 On Error GoTo HELL
     '// Ajustar a porcentaje
      ...
      Make_Transparent frmPlayList.hwnd, Slider1.Value
